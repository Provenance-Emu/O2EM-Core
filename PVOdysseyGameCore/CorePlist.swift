...
public extension PVBundleFinder {
    static var PVOdysseyGameCoreModule: Bundle { Bundle.module }
    static var PVOdysseyGameCoreBundle: Bundle { Bundle(for: PVOdysseyGameCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVOdysseyGameCoreBundle: Bundle { Bundle(for: PVOdysseyGameCore.self) }
...
@objc
extension PVOdysseyGameCore: EmulatorCoreInfoPlistProvider {

    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVOdysseyGameCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVOdysseyGameCoreBundle }
